...
Give it a [swing](http://gajus.com/sandbox/swing/examples/card-stack/)! and please [tweet it](http://gajus.com/sandbox/angular-swing/examples/card-stack/) if you like it. : )
